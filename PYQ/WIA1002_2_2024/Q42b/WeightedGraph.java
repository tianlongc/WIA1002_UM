...
public class WeightedGraph<T extends Comparable<T>, N extends Comparable<N>>{
    ...
    public int[][] adjMatrix(){
        ...
        ArrayList<T> vertices = getAllVertexObjects();
        ...
        for (int i = 0; i < adjMatrix.length; i++) {
            for (int j = 0; j < adjMatrix[i].length; j++) {
                ...
                if (hasEdge(source, destination)) {
                    adjMatrix[i][j] = (Integer)getEdgeWeight(source, destination);
                }else{
                    adjMatrix[i][j] = 0;
                }
            }
    ...
    public void traverseTree(T root){
    ...
    private void dFSHelper(T source, boolean[] visited){
        int index = getIndex(source);
        if (visited[index]) return; // avoid revisiting
        
        visited[index] = true;
        ArrayList<T> neighbours = getNeighbours(getVertex(index));
...
//        }
        ...
        /*
            After wasting too much time on figuring out I'm guessing of
            the example output supposedly to be
            Tree Traversal:
            Traversal: Kuching >
            Traversal: Melaka > Tawau >
            Traversal: Penang >
            ...
            Traversal:
            End Traversing..
            Reason: Two extra traversal is for Penang and Tawau with 0 neighbours
        */
    }
    
    public void displayTree(int i){
        System.out.print(getAllVertexObjects().get(i) + " > ");
    }
}
